...
interface FileUploadTeamProps {
  teamId: string;
}

export function FileUploadTeam({ teamId }: FileUploadTeamProps) {
  ...
  const uploadFile = async (file: File) => {
    ...
    try {
      ...
      formData.append("teamId", teamId); // Ajouter l'ID de l'équipe
            ...
            {isDragActive ? (
              ...
              <>
                <p className="text-lg text-gray-700 mb-2">
                  Uploader des fichiers pour l'équipe
                </p>
